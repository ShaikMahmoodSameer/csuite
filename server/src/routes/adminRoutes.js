...
const { getSeatingTables, addSeatingTable, getTableGuests, addGuestsToSeatingTable, getSeatingSofas, addSeatingSofa, getSofaGuests, addGuestsToSeatingSofa, getStngInfoByGid } = require('../controllers/adminControllers/seatingControllers');
...
router.get('/seatings/get-seating-by-guestid/:guestId', getStngInfoByGid)
