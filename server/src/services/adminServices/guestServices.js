...
const getUnseatedGuests = (callback) => {
    // pool.query('SELECT * FROM order_benificiary LEFT JOIN seating_table_guests ON order_benificiary.bnf_id = seating_table_guests.guest_id WHERE seating_table_guests.guest_id IS NULL;',
